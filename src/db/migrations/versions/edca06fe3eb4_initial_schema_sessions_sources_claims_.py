...
def upgrade() -> None:
    ...
    sa.Column('user_level', sa.Enum('beginner', 'intermediate', 'expert', name='userlevel'), nullable=False),
    sa.Column('status', sa.Enum('running', 'completed', 'failed', name='sessionstatus'), nullable=False),
